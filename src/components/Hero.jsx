      ...
      <div className="container-width section-padding text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="w-32 h-32 bg-gray-700 rounded-full mx-auto mb-8 flex items-center justify-center text-gray-400 border-2 border-primary-500"
          >
            <img
              className="w-[125px] h-[125px] bg-gray-700 rounded-full flex items-center justify-center object-cover"
              src="self.png"
              alt="self"
            />
          </motion.div>
